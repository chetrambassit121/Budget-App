...
class UserCreateAPIView(viewsets.ViewSet, CreateAPIView):  
    serializer_class = UserCreateSerializer
    queryset = ''
    # permission_classes = [IsAuthenticated]
    permission_classes = [AllowAny]
...
class UserListAPIView(viewsets.ViewSet, ListAPIView):
    queryset = User.objects.all()
    serializer_class = UserListSerializer
    # permission_classes = [IsAuthenticated]
    # permission_classes = [AllowAny]
...
class UserProfileAPIView(viewsets.ReadOnlyModelViewSet, ListAPIView):
    ...
    #     profile = UserProfileSerializer.objects.get(pk=pk)
    #     user = profile.user
    #     projects_data = ProjectSerializer.objects.filter(author=user)
    #     return Response(projects_data.data)

    # def get_projects(request, pk, *args, **kwargs):
    #     # profile = UserProfileSerializer(projects=projects)
